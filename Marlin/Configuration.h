...
#define STRING_CONFIG_H_AUTHOR "(sprintberlin)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT -1 // GS

/**
 * Select a secondary serial port on the board to use for communication with the host.
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 0 // GS
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_3 // GS
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_FUNCTIONAL_RANGE 20 // GS for dual heater If the temperature difference between the target temperature and the actual temperature
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET {0, 20, -1.10} // X offset: -left  +right  [of the nozzle] Y offset: -front +behind [the nozzle] Z offset: -below +above  [the nozzle]

// Certain types of probes need to stay away from edges
#define MIN_PROBE_EDGE 20

// X and Y axis travel speed (mm/m) between probes
#define XY_PROBE_SPEED 3000 // GS
...
#define HOMING_FEEDRATE_Z  3000 // GS
...
//
#define ENCODER_PULSES_PER_STEP 4 // GS from Bigtree SKR 1.3 manual
...
//
#define REVERSE_ENCODER_DIRECTION // GS from Bigtree SKR 1.3 manual
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER // GS
